    ...
    <div class="card shadow m-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin.posts.store') }}" method="post" id="postForm" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <div class="col-sm-10 mb-3 mb-sm-0">
                        <input type="text" class="form-control @error('title') border border-danger @enderror"
                               placeholder="Post Title" name="title" value="{{ old('title') }}" required autofocus>
                ...
                <div class="form-group row">
                    <div class="col-sm-10">
                        <input type="text" class="form-control @error('slug') border border-danger @enderror"
                               placeholder="Post Slug" name="slug" value="{{ old('slug') }}" required>
                ...
                <div class="form-group row">
                    <div class="col-sm-10">
                        <input type="checkbox" class="status-checkbox" id="status" value="1" name="status">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12 mb-3 mb-sm-0">
                                            <input type="text" class="form-control @error('meta_title') border border-danger @enderror"
                                                   placeholder="Meta Title" name="meta_title" value="{{ old('meta_title') }}">
